  ...
  return (
    <div className={className}>
      ...
      <div className="w-full text-center">
        {
          conversations.map((conversation, i) => <div className="flex bg-white my-4 p-6 items-center rounded-lg transition duration-300 transform hover:shadow-xl hover:-translate-y-2">
