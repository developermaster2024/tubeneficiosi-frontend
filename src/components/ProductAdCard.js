const ProductAdCard = ({title, subtitle, btnText, href, imgSrc, imgAlt}) => {
  return <div className="flex w-full bg-white rounded-sm shadow-sm overflow-hidden">
    <div className="flex flex-col justify-center items-start w-full p-8 space-y-4">
      ...
      <a
        href={href}
        className="inline-flex items-center justify-center px-5 py-3 space-x-2 leading-4 border border-white rounded bg-blue-500 text-white"
      >
        <span>{btnText}</span>
      </a>
    </div>
